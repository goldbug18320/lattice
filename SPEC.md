...
| `tracking` | Recon drones recalculate heading toward the assigned target's **current position** each tick and advance at 80% of max speed — target movement is followed continuously, not just aimed at the initial assignment position (Feature 26). |
